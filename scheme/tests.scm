...
(define (area-of-list lst) (map circle-area (filter even? lst)))
(area-of-list (list 1 2 3 4 5 7 8))
; expect (12.56 50.24 200.96)

(define (is-bigger-than-5? input)
  (cond
    ((< 5 input) True)
    ((> 5 input) False)
    ((= 5 input) (car '(Input=5)))))
(and (is-bigger-than-5? 6) (is-bigger-than-5? 4))
; expect #f

(or (is-bigger-than-5? 4) (is-bigger-than-5? 6))
; expect #t

(car '('shouldbeaquote))
;expect (quote shouldbeaquote)
