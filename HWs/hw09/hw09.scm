...
(define (derive-product expr var)
  ...
  (define m3 (derive m1 var))
  (define m4 (derive m2 var))
  (make-sum (make-product m3 m2) (make-product m4 m1))
)
...
(define (derive-exp exp var)
  ...
  (make-product (make-product (exponent exp) (derive (base exp) var)) (make-exp (base exp) (- (exponent exp) 1)))
)
